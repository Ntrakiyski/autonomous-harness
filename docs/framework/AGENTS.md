...
|---|---|---|
| PROJECT.md | The founding idea — problem, solution, success. Pre-PRD. | `docs/framework/PROJECT.md` |
| GUARDRAILS.md | Non-negotiable safety rules — git, filesystem, deploy, data | `docs/framework/GUARDRAILS.md` |
| ROLE.md | Bootstrap — how to become this agent | `docs/framework/ROLE.md` |
| ARCHITECTURE.md | System design, seams, data flow | `docs/framework/ARCHITECTURE.md` |
| DATABASE.md | Models, relationships, migrations | `docs/framework/DATABASE.md` |
| DESIGN.md | Visual tokens, components | `docs/framework/DESIGN.md` |
| TESTING.md | Testing strategy, evidence, E2E | `docs/framework/TESTING.md` |
| DEBUGGING.md | Structured logging, error tracing | `docs/framework/DEBUGGING.md` |
| VERSION-CONTROL.md | Git strategy, PRs, CI/CD, reviews | `docs/framework/VERSION-CONTROL.md` |
| COMMIT-TEMPLATE.md | Commit message format, learnings extraction | `docs/framework/COMMIT-TEMPLATE.md` |
| SUBAGENT.md | Inter-agent contract | `docs/framework/SUBAGENT.md` |
| HERMES.md | Hermes operations, dispatcher, spawn | `docs/framework/HERMES.md` |
| LEARNINGS.md | Accumulated knowledge | `docs/framework/LEARNINGS.md` |
| AUTONOMOUS.md | Full pipeline contract | `docs/framework/AUTONOMOUS.md` |
